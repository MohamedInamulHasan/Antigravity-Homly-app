                        ...
                        return (
                            <div key={item.id} className={`bg-white dark:bg-gray-800 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden border border-gray-100 dark:border-gray-700/50 group flex flex-col ${isSmall ? '' : 'h-full'}`}>
                                ...
                                <div className="p-6 flex flex-col flex-grow relative">
                                    ...
                                    {/* Full content - Re-adding line-clamp for grid view to keep cards uniform, user can click to expand/view details if we had a detail page. 
                                    However, user asked for full description in previous turn. 
                                    But in a grid of 4, full Description might break layout if long. 
                                    Let's keep it full but maybe limit height? Or just let it grow. 
                                    User said "show all description" in product details, and likely implied for News too in the request before.
                                    But a grid with varying heights is ugly. 
                                    I will set line-clamp-4 for the description to keep the grid neat, as is standard for cards. 
                                    Wait, user said "show all information of new" (sic - news) previously.
                                    If I make it a grid, showing "all information" (e.g. 500 words) in a small card column is bad UI.
                                    I'll stick to full content but text-sm. If it's too long it will just make that card tall. Masonry would be better but grid is requested.
                                    I'll add a max-height with scroll or overflow-hidden if I want to be safe, but let's try full content as requested first.
                                    Actually, for a "card" view, line-clamp is better. I'll add 'line-clamp-6' to allow a fair bit of text but not infinite.
                                */}
